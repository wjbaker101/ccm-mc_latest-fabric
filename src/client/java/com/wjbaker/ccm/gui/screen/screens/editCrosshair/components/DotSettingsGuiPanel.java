...
public final class DotSettingsGuiPanel extends PanelGuiComponent {
    ...
    public DotSettingsGuiPanel(
        ...
        var heading = new HeadingGuiComponent(this.parentGuiScreen, -1, -1, I18n.get("custom_crosshair_mod.screen.edit_crosshair.dot_settings"));
        ...
        var dotColourColourPicker = new ColourPickerGuiComponent(
            this.parentGuiScreen, crosshair, -1, -1, I18n.get("custom_crosshair_mod.screen.edit_crosshair.dot_colour"));
